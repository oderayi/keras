...
# Use Stochastic Gradient Descent (Loss function). 
# Other Loss functions exixt in the keras.optimizers package
# Adamax seem to be more accurate than SGD
